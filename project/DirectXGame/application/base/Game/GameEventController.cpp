...
namespace Game {
		...
		CameraManager* cameraManager, Character::CharacterManager* characterManager, InputSystem* input)
	{
		...
		CreateSpawn(Character::EnemyType::kSmallMelee, "wave1Rush", 1, 10, frontSpawn, narrowSpawnSize, 1.0f, 0.0f, 10, wave1Rush);
		...
		CreateSpawn(Character::EnemyType::kSmallMelee, "wave2Encircle", 1, 15, leftSpawn, wideSpawnSize, 1.0f, 0.0f, 20, wave2Encircle);
		...
		CreateSpawn(Character::EnemyType::kSmallMelee, "wave3Assault", 1, 20, frontSpawn, wideSpawnSize, 1.0f, 0.0f, 30, wave3Assault);
		...
		CreateSpawn(Character::EnemyType::kSmallMelee, "wave4Flow", 1, 15, leftSpawn, wideSpawnSize, 1.0f, 0.0f, 40, wave4Flow);
		CreateSpawn(Character::EnemyType::kSmallMelee, "wave4Hunters", 1, 8, rightSpawn, narrowSpawnSize, 1.0f, 0.0f, 41, wave4Hunting);
		...
		CreateSpawn(Character::EnemyType::kSmallMelee, "wave5Pressure", 1, 18, frontSpawn, wideSpawnSize, 1.0f, 0.0f, 50, wave5Pressure);
