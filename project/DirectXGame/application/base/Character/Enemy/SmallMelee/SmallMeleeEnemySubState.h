...
/// 攻撃準備
/// </summary>
class SmallMeleeAttackReadySubState :public BaseAttackSubState {
public:
    SmallMeleeAttackReadySubState(BaseCharacter* c, SubStateMachine<AttackSubState, BaseAttackSubState>* fsm)
