...
void Engine::EmitFunction::CreateParticle(ParticleGroup& group, EffectEmitData emitData, std::mt19937& randomEngine, Vector3 emitPos)
{
...
void Engine::EmitFunction::CreateParticle(ParticleGroup& group, EffectEmitData emitData, std::mt19937& randomEngine, Vector3 emitPos, Vector3 direction)
{
	Particle newParticle;
...
void Engine::EmitFunction::CreateParticle(ParticleGroup2d& group, EffectEmitData2d emitData, std::mt19937& randomEngine, Vector3 emitPos)
{
	Particle newParticle;
